...
exports.getChats = async (req, res, next) => {
  try {
    const result = await conn.chats.findAll();
...
exports.createChats = async (req, res, next) => {
  try {
    const result = await conn.chats.create(req.body);
...
exports.paginate = async (req, res, next) => {
  try {
    ...
    const count = await conn.chats.findAll();
...
exports.getChatsById = async (req, res, next) => {
  try {
    const result = await conn.chats.findOne({
...
exports.updateChats = async (req, res, next) => {
  try {
    const category = await conn.chats.findOne({
      where: {
        id: req.params.id,
      },
    });
    ...
    await conn.chats.update(req.body, {
      where: { id: req.params.id },
    });
