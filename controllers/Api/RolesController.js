...
exports.getRoles = async (req, res, next) => {
  try {
    const result = await conn.roles.findAll();
...
exports.createRoles = async (req, res, next) => {
  try {
    const result = await conn.roles.create(req.body);
...
exports.paginate = async (req, res, next) => {
  try {
    ...
    const count = await conn.roles.findAll();
...
exports.getRolesById = async (req, res, next) => {
  try {
    const result = await conn.roles.findOne({
...
exports.updateRoles = async (req, res, next) => {
  try {
    const category = await conn.roles.findOne({
      where: {
        id: req.params.id,
      },
    });
    ...
    await conn.roles.update(req.body, {
      where: { id: req.params.id },
    });
