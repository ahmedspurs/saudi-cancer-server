...
exports.search = async (req, res, next) => {
  ...
  await conn.partners
    ...
    .then(async function (assets) {
      var count = conn.partners.findAll();
...
exports.getPartners = async (req, res, next) => {
  try {
    const result = await conn.partners.findAll();
...
exports.createPartners = async (req, res, next) => {
  try {
    const result = await conn.partners.create(req.body);
...
exports.paginate = async (req, res, next) => {
  try {
    ...
    const count = await conn.partners.findAll();
...
//@route  GET
//@access Public
exports.getPartnersById = async (req, res, next) => {
  try {
    const result = await conn.partners.findOne({
...
//@route  Put
//@access Public
exports.updatePartners = async (req, res, next) => {
  try {
    const category = await conn.partners.findOne({
      where: {
        id: req.params.id,
      },
    });
    ...
    await conn.partners.update(req.body, {
      where: { id: req.params.id },
    });
