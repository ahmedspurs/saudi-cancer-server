...
exports.search = async (req, res, next) => {
  ...
  await conn.bank_accounts
    ...
    .then(async function (assets) {
      var count = conn.bank_accounts.findAll();
...
exports.getBankAccounts = async (req, res, next) => {
  try {
    const result = await conn.bank_accounts.findAll();
...
exports.createBankAccounts = async (req, res, next) => {
  try {
    const result = await conn.bank_accounts.create(req.body);
...
exports.paginate = async (req, res, next) => {
  try {
    ...
    const count = await conn.bank_accounts.findAll();
...
//@route  GET
//@access Public
exports.getBankAccountsById = async (req, res, next) => {
  try {
    const result = await conn.bank_accounts.findOne({
...
exports.updateBankAccounts = async (req, res, next) => {
  try {
    const category = await conn.bank_accounts.findOne({
      where: {
        id: req.params.id,
      },
    });
    ...
    await conn.bank_accounts.update(req.body, {
      where: { id: req.params.id },
    });
...
exports.deleteBankAccounts = async (req, res, next) => {
  try {
    ...
    await conn.bank_accounts.destroy({
      where: { id: req.params.id },
    });
