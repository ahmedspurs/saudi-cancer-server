...
exports.search = async (req, res, next) => {
  ...
  await conn.payment_methods
    ...
    .then(async function (assets) {
      var count = conn.payment_methods.findAll();
...
exports.getPaymentMethods = async (req, res, next) => {
  try {
    const result = await conn.payment_methods.findAll();
...
exports.createPaymentMethods = async (req, res, next) => {
  try {
    const result = await conn.payment_methods.create(req.body);
...
exports.paginate = async (req, res, next) => {
  try {
    ...
    const count = await conn.payment_methods.findAll();
...
//@route  GET
//@access Public
exports.getPaymentMethodsById = async (req, res, next) => {
  try {
    const result = await conn.payment_methods.findOne({
...
exports.updatePaymentMethods = async (req, res, next) => {
  try {
    const category = await conn.payment_methods.findOne({
      where: {
        id: req.params.id,
      },
    });
    ...
    await conn.payment_methods.update(req.body, {
      where: { id: req.params.id },
    });
...
exports.deletePaymentMethods = async (req, res, next) => {
  try {
    ...
    await conn.payment_methods.destroy({
      where: { id: req.params.id },
    });
