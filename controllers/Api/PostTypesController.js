...
exports.search = async (req, res, next) => {
  ...
  await conn.post_types
    ...
    .then(async function (assets) {
      var count = conn.post_types.findAll();
...
exports.getPostTypes = async (req, res, next) => {
  try {
    const result = await conn.post_types.findAll();
...
exports.createPostTypes = async (req, res, next) => {
  try {
    const result = await conn.post_types.create(req.body);
...
exports.paginate = async (req, res, next) => {
  try {
    ...
    const count = await conn.post_types.findAll();
...
//@route  GET
//@access Public
exports.getPostTypesById = async (req, res, next) => {
  try {
    const result = await conn.post_types.findOne({
...
//@route  Put
//@access Public
exports.updatePostTypes = async (req, res, next) => {
  try {
    const category = await conn.post_types.findOne({
      where: {
        id: req.params.id,
      },
    });
    ...
    await conn.post_types.update(req.body, {
      where: { id: req.params.id },
    });
...
//@route  Delete
//@access Public
exports.deletePostTypes = async (req, res, next) => {
  try {
    const category = await conn.post_types.findOne({
      where: {
        id: req.params.id,
